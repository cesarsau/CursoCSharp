    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            F.Imprimir("dd/mm/yyyy",0,0,0);
            Console.WriteLine("Cambiando formato.....");
            F.Imprimir("mm/dd/yyyy",0,0,0);
            Console.WriteLine("Cambiando formato.....");
            F.Imprimir("dd/MM/yyyy",0,0,0);
            ...
            Console.WriteLine("Cambiando formato y agregando hora.....\n");
                      
            FechaExtendida FE = new FechaExtendida(10, 20, 20);
            FE.Imprimir("dd/mm/yyyy hh:mm:ss",5,2,2020);
            Console.WriteLine("\nErrores de pruebas al ingresar numeros negativos Horas=-1, Minutos=-3, segundos =-5\n");
            FechaExtendida error = new FechaExtendida(-1, -3, -5);
            Console.WriteLine("\n");
            FE.Imprimir("dd/mm/yyyy hh:mm:ss", 5, 2, 2020);

            Console.WriteLine("\nCambiando formato de hora.....\n"); 

            FechaExtendida FA = new FechaExtendida(14, 20, 20);
            FA.Imprimir("dd/mm/yyyy hh:mm:ss", 5, 2, 2020);
